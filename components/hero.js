...
function SparkLogo() {
  return (
    <img className="relative h-[40px]" src="/img/logos/Apache_Spark_logo.svg"></img>
  );
}
function PandasLogo() {
  return (
    <img className="relative h-[40px]" src="/img/logos/Pandas_logo.svg"></img>
  );
}
function DataBricksLogo() {
  return (
    <img className="relative h-[40px] w-[80px]" src="/img/logos/databricks_logo.svg"></img>
  );
}
function AzureLogo() {
  return (
    <img className="relative h-[30px]" src="/img/logos/Microsoft_Azure_logo.svg"></img>
  );
}
