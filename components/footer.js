          ...
          <div>
            <div className="flex flex-wrap w-full -mt-2 -ml-3 lg:ml-0">
              {navigation.map((item, index) => (
                <Link key={index} href="/">
                  <a className="w-full px-4 py-2 text-gray-500 rounded-md ">
                    {item}
                  </a>
                </Link>
              ))}
          ...
          <div>
            <div className="flex flex-wrap w-full -mt-2 -ml-3 lg:ml-0">
              {legal.map((item, index) => (
                <Link key={index} href="/">
                  <a className="w-full px-4 py-2 text-gray-500 rounded-md  hover:text-darkBlue-500 focus:text-darkBlue-500 focus:bg-darkBlue-100 focus:outline-none ">
                    {item}
                  </a>
                </Link>
              ))}
